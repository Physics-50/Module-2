...
For this experiment, <strong>set the function generator (FG) to create a 40 kHz SQUARE wave with amplitude 5 V and offset 2.5 V</strong>. “Amplitude” for the FG means peak to peak voltage variation of the signal. The speakers are designed to work best at this frequency, and <strong> beads will only levitate stably if you use a square wave, not a sinusoidal wave</strong>.
