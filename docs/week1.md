...
As you set up to perform careful measurements, you may find it difficult to locate the maxima as precisely as you would like. You will collect additional measurements of these maxima in the coming weeks so it is worth investing the effort to determine a method that will allow you to perform the measurement precisely. Reducing the intensity of your diffraction maxima will reduce their spot size and may help with performing more precise measurements. One way to reduce the intensity of light is with two polarizers. [Click here for more information about polarizers](polarizers). Here's the net effect of a polarizer: only light polarized along the polarizer's axis will be transmitted. By adding a second polarizer and rotating the axis of its polarization you can control how much light gets through the pair. **Remember to turn off the laser when inserting components into the beam path of your laser.** Speak to your instructor if you would like to reduce the intensity of your beam but aren't sure how to make use of the polarizers.
