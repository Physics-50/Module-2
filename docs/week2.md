...
Choose one video from each new sphere diameter (1.8 mm, 2.5 mm, 4.5 mm, and 6.0 mm).  Following the method you used in Week 1, measure a terminal speed from each video you have chosen, and then calculate a viscosity value from that measured terminal speed and the other necessary quantities.
